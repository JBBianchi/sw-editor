...
1. **Setup**: Run the prerequisite script from repo root and parse JSON for FEATURE_DIR and AVAILABLE_DOCS list.
   - Bash: `bash .specify/scripts/bash/check-prerequisites.sh --json`
   - PowerShell: `powershell -ExecutionPolicy Bypass -File .specify/scripts/powershell/check-prerequisites.ps1 -Json`
