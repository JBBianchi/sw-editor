...
| [`008-rete-dynamic-sockets`](008-rete-dynamic-sockets/) | Implemented | Add orientation-aware custom Lit node rendering for `rete-lit` so socket placement follows flow direction across TB/LR modes and toggle cycles. |
