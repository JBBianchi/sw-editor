...
**Independent Test**: Register node renderer and toolbar action, mount slot components, verify rendering and dispatch.
...
- **FR-006**: System MUST support named slot UI extension points.
...
- **SC-002**: All supported extension points are usable through typed APIs without core code changes.
- **SC-003**: Lifecycle events provide enough data for host observability in all plugin state transitions.
